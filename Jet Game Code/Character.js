class Player extends CollisionEntity {
  ...
  handleCollision(e){
    if (!e.isProtected()) e.handleDamage(this.speed);
    if(!this.isProtected()){
      this.handleKnockback(e.getSize());
    }
  }
  
  handleKnockback(inputted_size){
    if (this.collideLeft) this.vx += inputted_size/this.knockback;
    else if (this.collideRight) this.vx -= inputted_size/this.knockback;
    if (this.collideUp) this.vy += inputted_size/this.knockback;
    else if (this.collideDown) this.vy -= inputted_size/this.knockback;
  }
}